...
//        Map<String, Double> carrosPopulares2020 = Map.of("gol", 14.4, "uno", 15.6, "mobi", 16.1, "hb20", 14.5, "kwid", 15.6)
        ...
        //HaspMap adiciona aleatoriamente
        ...
        System.out.println("Exiba a média dos consumos deste dicionário de carros: " + (somaConsumos/consumos.size()));
        ...
        Map<String, Double> carrosPoulares3 = new TreeMap<>(){{
            put("gol", 14.4);
            put("uno", 15.6);
            put("mobi", 16.1);
            put("hb20", 14.5);
        ...
        System.out.println(carrosPoulares3);
